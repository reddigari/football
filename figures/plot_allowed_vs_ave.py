...
fig1.savefig('figures/pass_allowed_vs_ave.png', dpi=200)
fig2.savefig('figures/rec_allowed_vs_ave.png', dpi=200)
fig3.savefig('figures/rush_allowed_vs_ave.png', dpi=200)
