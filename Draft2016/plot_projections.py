...
raw = pd.DataFrame.from_csv('FFA-CustomRankings.csv', index_col=None)
##columns are fucked up, need to shift names over and delete last one
cols = raw.columns.values
cols = np.append(cols, 'NA')
